    ...
    class Game
    {
        ...
        bool StartBattle(int roomNum, ref int turnCount)
        {
...

            {
                ...
                char input;
                GetInput(out input, "Attack", "Defend", "What will you do?");
            ...
            return _playerHealth != 0;
            // != checks if the function is true and false to the value in the right
        }
        ...
        void UogradeStats(int turnCount)
        {
            ...
            //+= subscribe to method  (righht operand) to the left event
        ...
        void GetInput(out char input, string option1, string option2, string query)
        {
            ...
            //!= check to se if a input is true or false
